...
const ContraForm = ({ onBack }) => {
  const [formData, setFormData] = useState({
    ...
    type: 'Debit',
    customer_name: 'Contra Transfer',
    customer_id: 'CONTRA001',
    customer_phone: '',
    account_name: '',
    amount: '',
    ref_number: '',
  ...
  const renderFormSection = () => (
    <div className="payment-section-container">
      ...
      <div className="form-grid" ref={formRef} onKeyDown={handleKeyDown}>
        ...
        {/* Customer Info (Fixed for Contra) */}
        <div className="form-row">
          <div className="field-group full-width">
            <label>Customer:</label>
            <input
              type="text"
              value="Contra Transfer"
              readOnly
              className="form-input readonly"
            />
          </div>
                  ...
                  <tbody>
                    {group.records.map((record, recordIndex) => (
                      <tr key={recordIndex}>
                        ...
                        <td>
                          <span className="type-badge contra">
                            {record.type}
                          </span>
                        </td>
                      </tr>
