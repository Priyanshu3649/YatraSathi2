...
const Bookings = () => {
  ...
  if (loading) {
    return <div className="bookings panel">Loading bookings...</div>;
  }

  return (
    <div className="bookings panel">
      <div className="bookings-header panel-header">
        <h2>Bookings</h2>
      ...
      {showForm && (
        <div className="booking-form panel mb-3">
              ...
              <tbody>
                {bookings.map((booking) => (
                  <tr key={booking.bk_bkid} className={getStatusClass(booking.bk_status)}>
                    ...
                    <td>{booking.bk_fromstation}</td>
                    <td>{booking.bk_tostation}</td>
                    <td>{new Date(booking.bk_travelldate).toLocaleDateString()}</td>
                    <td>{booking.bk_travelclass}</td>
